...
class DefaultSearchPrefsTests: XCTestCase {
    ...
    func testParsing() {
        ...
        let allEngines = ["yahoo", "bing", "duckduckgo", "netguide", "startpage", "google"]
        ...
        let japan = (lang: ["ja-JP", "ja"], region: "JP", resultList: ["yahoo-jp", "bing", "duckduckgo", "netguide", "startpage", "google"], resultDefault: "Google")
        let canada = (lang: ["en-CA", "en"], region: "CA", resultList: allEngines, resultDefault: "Google")
        let russia = (lang: ["ru-RU", "ru"], region: "RU", resultList: ["yandex-ru", "duckduckgo", "netguide", "startpage", "google"], resultDefault: "Яндекс")
